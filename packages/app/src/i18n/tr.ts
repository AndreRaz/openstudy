...
export const dict = {
  ...
  "dialog.plugins.empty": "Eklentiler study.json içinde yapılandırılır",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (study.json) sağlayıcı/model adlarını kontrol edin",
