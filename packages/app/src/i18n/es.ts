export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurados en study.json",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (study.json)",
