export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurés dans study.json",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (study.json) pour les noms de fournisseur/modèle",
