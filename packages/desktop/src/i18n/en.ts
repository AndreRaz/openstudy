export const dict = {
  ...
  "desktop.menu.help.documentation": "OpenStudy Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "OpenStudy CLI binary is missing. Try reinstalling the desktop app.",
