export const dict = {
  ...
  "desktop.updater.downloaded.prompt":
    "Version von OpenStudy wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das OpenStudy CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
