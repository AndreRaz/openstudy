export const dict = {
  ...
  "desktop.menu.help.documentation": "OpenStudy Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "OpenStudy CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
