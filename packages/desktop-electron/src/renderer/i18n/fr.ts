export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'OpenStudy",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'OpenStudy a été téléchargée. Voulez-vous l'installer et redémarrer ?",
