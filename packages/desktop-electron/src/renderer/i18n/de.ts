export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von OpenStudy",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von OpenStudy wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
