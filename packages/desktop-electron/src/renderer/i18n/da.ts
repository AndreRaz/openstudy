export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af OpenStudy",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af OpenStudy er blevet downloadet. Vil du installere den og genstarte?",
