export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of OpenStudy",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of OpenStudy has been downloaded, would you like to install it and relaunch?",
