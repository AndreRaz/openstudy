export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji OpenStudy",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} OpenStudy. Czy chcesz ją zainstalować i uruchomić ponownie?",
