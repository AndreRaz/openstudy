export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju OpenStudy-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} OpenStudy-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
