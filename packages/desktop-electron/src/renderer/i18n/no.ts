export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av OpenStudy",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av OpenStudy er lastet ned. Vil du installere den og starte på nytt?",
